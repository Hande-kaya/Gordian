/**
 * StepIllustrations - Small inline SVG icons for tutorial topics.
 */
...
export const UploadIcon: React.FC<IconProps> = ({ size = 24, color = '#059669' }) => (
...
export const ChartIcon: React.FC<IconProps> = ({ size = 24, color = '#059669' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M18 20V10M12 20V4M6 20v-6" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const ExportIcon: React.FC<IconProps> = ({ size = 24, color = '#059669' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const GearIcon: React.FC<IconProps> = ({ size = 24, color = '#059669' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const EditIcon: React.FC<IconProps> = ({ size = 24, color = '#059669' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const InvoiceIcon: React.FC<IconProps> = ({ size = 24, color = '#059669' }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
